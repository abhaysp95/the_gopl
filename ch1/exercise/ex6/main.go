...
// more values to palette and then displ aying them by changing the third
...
var palette = []color.Color{color.White, color.Black, color.RGBA{0x00, 0x00, 0xff, 0xff}, color.RGBA{0x00, 0xff, 0x00, 0xff}, color.RGBA{0xff, 0x00, 0x00, 0xff}}
...
const (
	...
	redIndex = 4    // fifth color in palette
)
