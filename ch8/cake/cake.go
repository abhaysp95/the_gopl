// package cake provides a simulation of a concurrent cake shop with
// numerous parameters
...
type Shop struct {
	...
	IceBuf int                   // buffer slots between icing
...
// distributed around d, with standard deviation of stddev
